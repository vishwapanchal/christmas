...
echo "Fixing letter visibility, titles, and layout..."
...
<body>
  ...
  <header class="hero" id="top">
    <nav class="nav" aria-label="Main navigation">
      ...
      <ul class="nav__links">
        ...
        <li><a href="#message">Heartfelt Wish</a></li>
  ...
  <footer class="footer">
    <p>
      Made with ❤️ and code by <span class="accent">Vishwa Panchal</span><br>
      Dedicated to <span class="accent">Neelam Ma'am</span>
    </p>
    <p class="footer__mini">Merry Christmas & Happy New Year</p>
  </footer>
...
@media(max-width: 768px) {
  ...
  .nav__toggle span { width: 25px; height: 2px; background: white; transition: 0.3s; }
...
.gift-name { font-family: "Cinzel", serif; font-size: 1.2rem; display: block; color: #0f172a; font-weight: bold; }
...
.section__title { font-size: 2rem; text-align: center; font-family: "Cinzel", serif; margin-bottom: 0.5rem; }
...
.message-card__closing { margin-top: 2rem; font-family: "Cinzel", serif; color: white; border-top: 1px solid rgba(255,255,255,0.1); padding-top: 1rem; }
...
/* -------------------------------------
   ...
   ------------------------------------- */
.snow-cards-container { 
  display: flex; flex-wrap: wrap; justify-content: center; gap: 2rem; 
}

.snow-card {
  position: relative; width: 320px; height: 420px; /* Increased height for content */
...
.letter-content {
  ...
  display: flex; flex-direction: column; justify-content: space-between; /* Space out content */
  color: var(--paper-text); text-align: center;
  z-index: 1; 
  opacity: 0; /* Hidden initially to prevent text peek */
  transition: opacity 0.5s ease 0.5s; /* Fade in as snow melts */
}
.snow-card.melted .letter-content { opacity: 1; }

.letter-content h4 { 
  font-family: "Cinzel", serif; color: #b91c1c; margin-bottom: 1rem; font-size: 1.2rem; 
  font-weight: 600;
}
.letter-content p { 
  font-size: 0.9rem; line-height: 1.7; margin-bottom: 1rem; flex-grow: 1;
  display: flex; align-items: center; /* Center text vertically */
}
.letter-sign { 
  font-family: "Great Vibes", cursive; font-size: 1.5rem; color: var(--accent-dark); 
  margin-top: 1rem; align-self: flex-end; width: 100%; text-align: right;
}

/* The Snow Cover (Overlay) */
.snow-cover {
...
.snow-icon { 
  ...
  animation: pulseSnow 2s infinite ease-in-out;
}
@keyframes pulseSnow {
...
echo "Letters fixed: 'For Your Guidance' title restored, full text visible, and layout improved!"